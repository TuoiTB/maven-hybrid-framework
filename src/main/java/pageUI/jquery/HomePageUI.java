...
public class HomePageUI {
	...
	public static final String ALL_VALUE_BY_COLUMN_NAME = "xpath=//tr/td['%s']";
	
	public static final String COLUMN_INDEX_BY_COLUMN_NAME_1 = "xpath=//th[text()='%s']/preceding-sibling::th";
	public static final String TEXTBOX_BY_ROW_INDEX_AND_COLUMN_INDEX = "xpath=//tr['%s']/td['%s']";
	public static final String DROPDOWN_BY_ROW_INDEX_AND_COLUMN_INDEX = "xpath=//tr['%s']/td['%s']//select";
	public static final String CHECKBOX_BY_ROW_INDEX_AND_COLUMN_INDEX = "xpath=//tr['%s']/td['%s']//input[@type='checkbox']";
}
